...
if ($Id) {
    ...
    if ($status === 'WIP') {
        ...
        // OASIS
     $oasissegementpending = "SELECT `header`,`M_item`, `Agency_response`, `Coder_response`, `Coder_rationali` FROM `oasis` WHERE `Entry_Id`='$Id' AND `code_status` IS NULL ";
