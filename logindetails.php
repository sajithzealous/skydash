...
include 'style.php';
 ?>
    ...
    <div class="card">
        <div class="card-body">
            <p class="card-title mb-0 text-primary text-uppercase">Login-Details</p><br><br>
...
.custom-scroll1 {
 ...
 <div class="row">
          ...
          <p class="card-title mb-0 text-primary text-uppercase">Login-Report</p><br><br>
            ...
            <table class="table table table-striped   table-hover" width="110%" id="logindetaildata">
              <thead class="bg-primary text-white" id="headers1" >
                <tr>
                  ...
                  <th id="head" class="border-bottom pb-2" style="text-align: center;">Login Time</th>
                  <th id="head" class="border-bottom pb-2" style="text-align: center;">Logout Time</th>
                  <th id="head" class="border-bottom pb-2" style="text-align: center;">Login Hours</th>
               
                </tr>
              </thead>
              <tbody id="show_logindata" style="text-align: center;">
