...
function datadisplaytable() {
  fetch("Adminpanel/codedescrptionnewsql.php")
...
function createDataTable(data) {
  ...
  return $("#codedescriptiontable").DataTable({
    lengthMenu: [
      [15, 25, 50, -1],
      [15, 25, 50, "All"],
    ],
    ...
    columns: [
      ...
      { data: "icdcode" },
      { data: "Description" },
      { data: "clinicalgroupname" },
      { data: "comorbiditygroup" },  
      { data: "diagnosistype" },  
      { data: "Category" },  
      { data: "status" },  
      { data: "Effective_date" },  
    ...
    initComplete: function () {
      var table = $("#codedescriptiontable");
...
function addColumnFilter(column, index) {
  ...
  ).appendTo("#cgltable th.filterRow:nth-child(" + (index + 1) + ")");
...
//     $.ajax({
//       url: "Adminpanel/create-comorbiditylow.php?action=update_status",
//       type: "get",
//       data: {
//         row_id: row_id,
//         status: status,
...
// function showdata() {
//   $.ajax({
//     url: "Adminpanel/create-comorbiditylow.php?action=get_active_count",
//     type: "get",
//     data: {},
//     success: function (response) {
//       console.log(response);
...
//         $("#activecgl").html(total_active);
//         $("#inactivecgl").html(total_inactive);
//         $("#totalcgl").html(total_count);
//       } else {
//       }
//     },
//   });
