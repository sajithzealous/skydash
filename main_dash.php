...
<!-- <input id="datepicker1" class="custom-daterangepicker float-right"> -->
          ...
          <br>
              ...
              <script src="upload/js/client_data_count.js" type="text/javascript"></script>
               <script src="upload/js/client_data_show_dash.js" type="text/javascript"></script>
                <script src="upload/js/client_age_of_file.js" type="text/javascript"></script>
               <!-- <script src="upload/js/client_data_table.js" type="text/javascript"></script>   -->
