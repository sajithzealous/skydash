...
if (isset($_POST['Id'])) {
    ...
    $sqlDataCoder = "SELECT `ICD-code` FROM `Codesegement` WHERE `Entry_Id`='$Id' AND `Coderchecked`='$coderChecked' AND `M-Items`='$mitem' AND `code_status` IS NULL";
    ...
    $sqlDataAgency = "SELECT `ICD-code` FROM `Codesegement` WHERE `Entry_Id`='$Id' AND `Agencychecked`='$agencyChecked' AND `Agencyprimarycode`='$agencyprimarycode' AND `code_status` IS NULL";
