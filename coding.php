                    ...
                    <div class="row mt-3">
                        ...
                        <ul class="d-inline-block mr-3 completed " id="completed" value="<?php echo $Id; ?>">
                            ...
                            <ul class="d-inline-block mr-3 hhrgpreview" id="hhrgpreview" value="<?php echo $Id; ?>">   
                              ...
                              <ul class="d-inline-block mr-3 hhrgworksheet" id="hhrgworksheet" value="<?php echo $Id; ?>">   
                                <li style="--i:#56CCF2;--j:#2F80ED;">
                                    <span class="icon"> <img src="gifs/ey.png" style="height: 35px;"></span>
                                    <span class="title">HHRG Worksheet</span>
                                </li>
                            </ul>
                    ...
                    <div class="col-12 grid-margin stretch-card">
                        ...
                        <div class="card">
                         ...
                         <center>
                                   ...
                                   <h4 class="card-title d-inline m-5">HHRG WorkSheet </h4>    <div class="ml-5  " style="margin-top: -29px; margin-right: -144px;">
...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="contentbody" id="contentToCopy"></p>
      </div>
      <div class="modal-footer">
...
?>
    ...
    <script src="Assign/js/oasis.js?<?php echo $randomNumber ?>"></script>
    ...
    <script src="Assign/js/preview.js?<?php echo $randomNumber ?>"></script>
...
<script>
    ...
    //     const fromIcdValue = document.getElementById(`icd-${fromId}`)
    //     const fromDescValue = document.getElementById(`description-${fromId}`)
    //     const fromDateValue = document.getElementById(`date-${fromId}`)
    //     const fromEoValue = document.getElementById(`eo-${fromId}`)
    //     const fromRatingValue = document.getElementById(`rating-${fromId}`)

    //     const toIcdValue = document.getElementById(`icd-${toId}`)
    //     const toDescValue = document.getElementById(`description-${toId}`)
    //     const toDateValue = document.getElementById(`date-${toId}`)
    //     const toEoValue = document.getElementById(`eo-${toId}`)
    //     const toRatingValue = document.getElementById(`rating-${toId}`)

    //     const tempIcdValue = toIcdValue.value
    //     const tempDescValue = toDescValue.value
    //     const tempDateValue = toDateValue.value
    //     const tempEoValue = toEoValue.value
    //     const tempRatingValue = toRatingValue.value

    //     toIcdValue.value = fromIcdValue.value
    //     fromIcdValue.value = tempIcdValue

    //     toDescValue.value = fromDescValue.value
    //     fromDescValue.value = tempDescValue

    //     toDateValue.value = fromDateValue.value
    //     fromDateValue.value = tempDateValue


    //     toEoValue.value = fromEoValue.value
    //     fromEoValue.value = tempEoValue

    //     toRatingValue.value = fromRatingValue.value
    //     fromRatingValue.value = tempRatingValue
