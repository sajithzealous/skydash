 ...
 ?>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
                ...
                <div class="col-md-6 mb-4 stretch-card transparent" data-toggle="modal" data-target=".bd-example-modal-lg-edit">
                  <div class="card card-tale">
                    <div class="card-body demo" id="" value="">
                      <h4>New Files</h4><br>
                      <p class="fs-30 mb-1" id="user_assing"> </p>
                      <p> </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card  " style="background-color:#186b78">
                    <div class="card-body " id="">
                      ...
                      <p class="fs-30 mb-1" id="user_wip" style="color:white"> </p>
                      <p> </p>
                    </div>
                  </div>
                </div>  
              ...
              <div class="row">
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card   " style="background-color: #7a839bd1;">
                    <div class="card-body" id="">
                      <h4 style="color:white">Alloted To QC</h4><br>
                      <p class="fs-30 mb-1" id="user_qc" style="color:white"> </p>
                      <p> </p>
                    </div>
                  </div>
                </div>
                <div class="col-md-6 mb-4 stretch-card transparent" data-toggle="modal" data-target=".bd-example-modal-lg-edit">
                  <div class="card card-dark-blue">
                    <div class="card-body" id="cmd_file">
                        <h4>Approved Files</h4><br>
                      <p class="fs-30 mb-1" id="user_appproved"> </p>
                      <p> </p>
                    </div>
                  </div>
                </div>
         ...
         <script src="upload/js/userdash.js" type="text/javascript"></script>
        </div>
      </div>
    </div>
  </div>
