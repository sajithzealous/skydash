...
<body>
                            ...
                            <div class="card-head csd"><br>
                               ...
                               <center>  
                                    <h4 class="card-title d-inline m-5">GG-Mitems </h4>   <div class="ml-5  " style="margin-top: -29px; margin-right: -144px;">
                                       ...
                                       <label class="switch">
                                     <input type="checkbox" class="chk  schk">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="container-fluid" style="background: white;">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <button class="save_button  btn_save_oasis .btn-icon-prepend submit ml-2 mb-3" type="button" id="btn_save_gg" style="float: right;" name="submit" value="submit">
                                                <span>Save</span>
                                            </button>
                                        </div>
    ...
    <script src="js/template.js"></script>
     <script src="ggmitem/js/ggmitem.js"></script>
     <script src="Ryi/js/ryi.js"></script>
     <!-- <script src="Ryi/js/ryi_new.js"></script> -->

    <!-- SCRIPT -->
    <script src="Assign/js/insertcodesegement-v2.js?weer"></script>
...
<script>
    ...
    document.getElementById('btn_save_gg').addEventListener('click', function() {
    var element = document.getElementById('myCollapsible4');
    element.style.display = 'none';
