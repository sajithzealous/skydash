...
<body>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9">
                                                <span id="lc" style="color:red"></span>
                                               <input type="text" class="form-control" id="dob" name="dob" placeholder="MM/DD/YYYY" value="<?php echo !empty($dob) ? $dob : '' ?>"/>
 ...
 <?php $randomnum =rand(0000,9999) ?>
    ...
    <script src="js/template.js"></script>
     <!-- <script src="Ryi/js/qa_ryi.js"></script> -->
    <script src="ggmitem/js/qc_ggmitem.js?<?php echo $randomnum ?>"></script>
    <script src="QA/js/qc_insertcodesegement.js?<?php echo $randomnum ?> "></script>
    ...
    <script src="QA/js/qc_preview.js"></script>
