        ...
        if (!$.fn.DataTable.isDataTable("#assign_table_data")) {
          ...
          table = $("#assign_table_data").DataTable({
            ...
            columns: [
              {
                title:
                  "<input type='checkbox' id='selectAllCheckbox' class='form-control' name='selectAllCheckbox' style='height:20px'>",
                className: "no-sort",
              },
              { title: "Id" },
              { title: "Patient Name" },
                    ...
                    try {
                      ...
                      responses.forEach(function (response) {
                        if (response.success) {
                          ...
                          $("input[name='selectAllCheckbox']").prop("checked", false);
                          ...
                          $("input[name='File']").each(function () {
                            ...
                            if (selectedFiles.has(fileId)) {
                              ...
                              // alert(fileId);
                              selectedFiles.delete(fileId);
                              selectedFiles.clear(fileId);
                            } else {
                              $(this).prop("checked", false);
                            }
                          });
                          
                          // Clear and update the count display
