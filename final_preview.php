 ...
 <?php
  ...
  <button class="btn btn-primary float-right my-4" onclick="downloadPDF()">
   ...
   <div class="table-responsive">
    ...
    <table class="table     table-hover" id="Codnig-table">
        <thead style="color: whitesmoke; background: #4C4CAC;">
            <tr>
                <th>MItems</th>
                <th>ICD</th>
...
#oasisqc-table td {
 ...
 <div class="table-responsive" id="oasis-table">
    <h5>Oasis Segment</h5>
    <table class="styled-table fixed-header-width table table-bordered   table-hover" id="oasisqc-table">
        <thead style="color: whitesmoke; background: #4C4CAC;">
            <tr>
                <th>MItems</th>
...
<div class="gg" id="gg-items">     
    <h4 >GG-Mitem</h4>
    <table class="table  table-bordered table-hover     Response" id="dataTable">
        <thead style="color: whitesmoke; background: #4C4CAC;">
...
.table-bordered td {
   ...
   <!--QC POC Details Table -->
      <div class="table-responsive" id="poc-table">
    <h5>POC Segment</h5>
 ...
 <?php  $randomNumber = rand(1000, 9999);  ?>
  ...
  <script src="Assign/js/final_preview.js?<?php echo $randomNumber?>"></script>
