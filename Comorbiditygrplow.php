...
<head>
    ...
    <title>Comorbidity Group Low</title>
                    ...
                    <div class="container">
                            <div class="card-deck">
                                <div class="card cardfer">
                                    ...
                                    <div class="card-body">
                                        <h3 class="card-title card-image-heading">Active Comorbidity Low</h3>
                                        <p class="card-text" id="activecgl"></p>
                                    </div>
                                ...
                                <div class="card cardfer">
                                   <!-- <img class="card-img-top" src="gifs/inactiveagency.gif" alt="Image Description" style="height:240px;"> -->
                                     <div class="card-body">
                                        <h3 class="card-title card-image-heading">Inactive Comorbidity Low</h3>
                                        <p class="card-text" id="inactivecgl"></p>
                                    </div>
                                ...
                                <div class="card cardfer">
                                   <!-- <img class="card-img-top" src="gifs/totalagency.gif" alt="Card image cap"> -->
                                    ...
                                    <div class="card-body">
                                        <h3 class="card-title card-image-heading">Total Comorbidity Low</h3>
                                        <p class="card-text" id="totalcgl"></p>
                                    </div>
                    ...
                    <div class="conatiner m-5">
                        ...
                        <!--                                
                                ...
                                <button type="button" class="btn btn-info mr-2 clk_2" data-toggle="modal"
                                    data-target="#cglLink" style="float:right"> Create</button>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12 custom-scroll table-responsive p-5"
                                ...
                                <table id="cgltable" class="display table">
                                    <thead>
                                        <tr class="headerrow">
...
<?php  $rand =rand(0000,9999) ?>
    <script src="Adminpanel/js/comorbiditylow.js?<?php echo $rand ?>"></script>
