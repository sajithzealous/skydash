...
<body style="background-color: #E6E6E6; user-select: none;">
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(response) {
                                                ...
                                                if ('error' in response) {
                                                    console.error('Errors loading data:', response.error);
    ...
    response.data.forEach(function(row) {
        const defaultMItem = [
            "M1021A", "M1023B", "M1023C", "M1023D", "M1023E", "M1023F", "M1023G", "M1023H", "M1023I", 
            "M1023J", "M1023K", "M1023L", "M1023M", "M1023N", "M1023O", "M1023P", "M1023Q", "M1023R", 
            "M1023S", "M1023T", "M1023U", "M1023V", "M1023W", "M1023X", "M1023Y",
        ];

        $('#tableBody').append(`
            <tr>
                ${defaultMItem.includes(row["M-Items"]) ? 
                    `<td style="border: 1px solid black; white-space: pre-wrap;">${row['M-Items']}</td>` : 
               ...
               <td style="border: 1px solid black; white-space: pre-wrap; text-align: center;">
    ${row.Rating === 'None' ? " " : row.Rating}
</td>
                            ...
                            <script>
                                $(document).ready(function() {
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid black; white-space: pre-wrap;word-break: auto;word-spacing: normal;overflow: auto;overflow-x: auto; max-width: 100px;width: 80%;">${row['Coder_rationali']}</td>
                            ...
                            <script>
                                $(document).ready(function() {
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid black; white-space: pre-wrap;word-break: auto;word-spacing: normal;overflow: auto;overflow-x: auto; max-width: 100px;width: 80%;">${row['Coder_response']}</td>
...
var options = {
    margin: [0, 0.3, 1, 0.3], //[top, left, bottom, right]
    filename: filename + ".pdf",
    image: { type: "jpeg", quality: 0.7 }, // Reduce image quality
