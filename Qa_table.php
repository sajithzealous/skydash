...
<body>
    ...
    <div class="container-scroller">
        ...
        <div class="container-fluid page-body-wrapper">
          ...
          <?php if ($role === 'QA' || $role === "superadmin") { ?>
            <!-- Filtter start -->
            <div class="card mb-3">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    ...
                    <?php
                    include 'filter/coders_filter.php';
                    ?>

                  </div>
                  <div class="col-md-6">

                    <button type="button" class="btn btn-primary ml-5  mt-1" id="QA_search">
                      Search</button>
                  </div>
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="table-responsive">
                                                    <table id="qa_table_data" class="display expandable-table" style="width:100%">
                                                        <thead>
                                                            <tr class="table">
                                                            </tr>
                                                        </thead>
        ...
        <?php if ($role === 'QaTl' || $role === "superadmin") { ?>
            <!-- Filtter start -->
            <div class="card mb-3">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-2">
                    ...
                    <?php
                    include 'filter/Qatl_filter.php';
                    ?>
                  </div>
                  ...
                  <div class="col-md-3">
                    ...
                    <?php
                    include 'filter/QcTeamWise_Coder.php';
                    ?>

                  </div>
                  <div class="col-md-5">

                    <button type="button" class="btn btn-primary ml-3  mt-1" id="QA_search">
                      Search</button>
                      <button type="button" class="btn btn-primary ml-3  mt-1" id="QA_assign">
                      Assign</button>
                  </div>
                    ...
                    <div class="card mb-3">
                        <div class="row">
                          ...
                          <img src="loading.gif" alt="Loading..." />
                                        ...
                                        <div class="row">
                                            <div class="col-auto">
                                                <p class="card-title">QA Files Assign</p>
                                            </div>
                                        </div>
        ...
        <!-- <script src="QA/js/Qa_v1.js?<?php echo $randnum ?>"></script> -->
        <script src="QA/js/Qa.js?<?php echo $randnum ?>"></script>
</body>
