...
if (isset($_GET['fromdate']) && isset($_GET['todate'])) {
    ...
    $sql = "SELECT `alloted_team`, `agency`, `patient_name`, `phone_number`, `mrn`, `status`, `alloted_to_coder`, `insurance_type`, `assesment_type`, `assesment_date`
          FROM Main_Data WHERE ( `status`='REASSIGNED TO CODER' OR `status`='ASSIGNED TO CODER' OR `status`='ASSIGNED TO TEAM' OR `status`='REASSIGNED TO TEAM' )
