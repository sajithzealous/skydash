...
if ($Id !== '')
{
    ...
    $agencyDataQuery = "SELECT `ICD-code` FROM `Codesegement` WHERE `Entry_Id` = '$Id' AND `Agencychecked` = 'Agency' AND `Agencyprimarycode` != 'Primary' AND  `code_status`IS NULL ";
    ...
    // Fetching coder data
    $coderDataQuery = "SELECT `ICD-code` FROM `Codesegement` WHERE `Entry_Id` = '$Id' AND `Coderchecked` = 'Coder' AND `M-Items` != 'M1021A' AND  `code_status`IS NULL";
