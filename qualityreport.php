...
<body>
    ...
    <div class="card">
        <div class="card-body">
            <p class="card-title mb-0 text-primary text-uppercase">Quality-Report</p><br><br>
            <button type="button" class="btn btn-primary btn-sm float-right y-3" id="searchbtn2" style="margin-top: -67px;">Search</button>
<!--             <div class="dropdown float-right y-3" style="margin-top: -67px;margin-right: 97px">
  ...
  <div class="dropdown-menu">
    <ul class="items" s>
      ...
      <li><input type="checkbox" class="column-toggle ui-checkbox" data-column="2" checked> CoderName </li>
      <li><input type="checkbox" class="column-toggle ui-checkbox" data-column="3" checked> CoderEmpid</li>
      <li><input type="checkbox" class="column-toggle ui-checkbox" data-column="5" checked> Patient_name </li>
      <li><input type="checkbox" class="column-toggle ui-checkbox" data-column="6" checked>Mrn  </li>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="date" class="form-control" id="from_date2" value="<?php echo date('Y-m-d'); ?>" required>
        </div>
    </div>
</div>
<div class="col-md-3">
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="date" class="form-control" id="to_date2" value="<?php echo date('Y-m-d'); ?>" required>
        </div>
    </div>
</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                               <!--  <select class="form-control" name="team" id="team_select">
                                  ...
                                  <select class="form-control" name="team" id="team_select2" style="color:black;font-weight: 6000;">
    ...
    <?php } ?>
                    ...
                    <div class="col-md-2">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="coder_name2" name="coder" style="color:black;font-weight: 6000;">
    ...
    <div class="form-group row">
        <div class="col-sm-10">
            <div class="dropdown" style="position:relative;">
                <button class="  btn-secondary dropdown-toggle" type="button" id="agencyDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: 15px; background-color: white; color: black;height: 50px;
    width: 189px;">
                    Select Agency
                </button>
                <div class="dropdown-menu" aria-labelledby="agencyDropdown" style="max-height: 200px; overflow-y: auto; width: 300px; border: 2px solid black;">
                    <?php foreach ($agency_name as $row) { ?>
                        <div class="dropdown-item" style="padding: 10px; display: flex; align-items: center;">
                            <input type="checkbox"  name="Agencies[]" id="<?= htmlspecialchars($row['agency_name']) ?>" value="<?= htmlspecialchars($row['agency_name']) ?>" style="margin-right: 10px;">
...
<br><br><br>
  ...
  <img id="download_excel1" src="images/dd.png" title="Download" class="NEW float-right hover:bg-primary-600" style="width: 45px; margin-top: -8px; margin-left: 420px; ">
    ...
    <table class="table table-striped table-bordered" id="table_report2">
        <thead style="background: #4b49ac; color: white;"id="head1">
            <tr>
                <th>Sno</th>
                <th>Coder</th>
                <th>CoderEmpid</th>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/xlsx/0.17.2/xlsx.full.min.js"></script>
    ...
    <script src="report_files/js/mis_report.js"></script>
