    ...
    success: function (response) {
      ...
      if (positionOneValue.length != 1) {
        Swal.fire({
          ...
          text: "Please fill in all Mitems.",
          width: "20%",
          height: "10%",
        });
        return;
...
function position3(clinicalGroupName, deferred) {
  ...
  $.ajax({
    type: "post",
    url: "Ryi/ryi_oasisjsonfetch.php",
    data: {
      Id: Id,
    },
    ...
    success: function (response) {
      ...
      var totalcodervalue =
       ...
       console.log("totalcodervalue",totalcodervalue);
       console.log("totalagencyvalue",totalagencyvalue);
...
function position4(data) {
  $.ajax({
    ...
    success: function (response) {
      // Assuming 'response' is your JSON array
