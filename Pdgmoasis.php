...
<body>
                    ...
                    <div class="container">
                            <div class="card-deck">
                                <div class="card cardfer">
                                    ...
                                    <div class="card-body">
                                        <h3 class="card-title card-image-heading">Active PDGM Oasis</h3>
                                        <p class="card-text" id="activepdgm"></p>
                                    </div>
                                ...
                                <div class="card cardfer">
                                   <!-- <img class="card-img-top" src="gifs/inactiveagency.gif" alt="Image Description" style="height:240px;"> -->
                                     <div class="card-body">
                                        <h3 class="card-title card-image-heading">Inactive PDGM Oasis</h3>
                                        <p class="card-text" id="inactivepdgm"></p>
                                    </div>
                                ...
                                <div class="card cardfer">
                                   <!-- <img class="card-img-top" src="gifs/totalagency.gif" alt="Card image cap"> -->
                                    ...
                                    <div class="card-body">
                                        <h3 class="card-title card-image-heading">Total PDGM Oasis</h3>
                                        <p class="card-text" id="totalpdgm"></p>
                                    </div>
                    ...
                    <div class="conatiner m-5">
                        ...
                        <!--                                
                                ...
                                <!-- <button type="button" class="btn btn-info mr-2 clk_2" data-toggle="modal"
                                    data-target="#pdgmLink" style="float:right"> Create</button> -->
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xl-12 custom-scroll table-responsive p-5"
                                ...
                                <table id="pdgmtable" class="display table">
                                    <thead>
                                        <tr class="headerrow">
                                            <th class="sorting">S.no</th>
                                            <th class="sorting">Id</th>
                                            <th class="sorting">Mitem Name</th>
                                            <th class="sorting">Mitem</th>
                                            <th class="sorting">Mitem Options</th>
                                            <th class="sorting">Mitem Values</th>
    ...
    <div class="modal fade" id="pdgmLink" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLongTitle">New PDGM Oasis</h4>
...
<?php  $rand =rand(0000,9999) ?>
    <script src="Adminpanel/js/pdgmoasis.js?<?php echo $rand ?>"></script>
