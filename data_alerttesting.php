...
FROM 
    `Agent` a
LEFT JOIN 
    `Main_Data` md ON a.agency_name = md.agency AND DATE(md.log_time) = '$todayDate'
WHERE 
    a.count_status = 'Yes'
GROUP BY 
    a.agency_name;
";
 ...
 $emailHead = "<h2>Active Agencies and Data Counts for $todayDate ($total_count)</h2>";
  ...
  $mail->addAddress('kamil.zealousservices@gmail.com', 'Joe User');


    // Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = 'Active Agencies and Data Counts for Today';
