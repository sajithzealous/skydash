            ...
            <div class="main-panel">
               ...
               <div class="card p-2">
                        <div class="card-header">
                            <h3>Agency Invoice</h3>
                            <button type="button" class="btn btn-primary mr-2" style="float:right" onclick="window.open('agencyinvoicelist.php')">Invoice list</button>
                                ...
                                <table id="data_table" class="display table">
                                    <thead>
                                        <tr class="headerrow">
                                            ...
                                            <th class="sorting"> Client Uid</th>
                                            <th class="sorting">Client Name</th>
                                            <th class="sorting">Company Name</th>
                                            <th class="sorting">Primary Email</th>
                                            <th class="sorting">Primary Phone</th>
                                            <th class="sorting">Billing Method</th>
                                            <th class="sorting">Billing Period</th>
                                            <th class="sorting">Invoice Period</th>
                                            <th class="sorting">Payment Method</th>
                                            <th class="sorting">Cost</th>
                                            <th class="sorting">Status</th>
                                            <th class="sorting">Invoice List</th>
