...
foreach ($data as $row) {
    ...
    $mitemcheckingprimary=$row['mitemchecking'];
    ...
    if ($icd != "" && $description != "" && $effectivedate != "") {
        if ($mitems == "M1021A") {
            ...
            if ($mitemssqlresultExist) {
                $updateQuery = "UPDATE `Codesegement` SET `M-Items`='$mitems', `ICD-code`='$icd', `Description`='$description', `Effective_Date`='$effectivedate', `Eo`='$eo', `Rating`='$rating',`Coderchecked`='$coderchecked',`Agencychecked`='$agencychecked',`Agencyprimarycode`='$mitemcheckingprimary',`User`='$user',`coder_emp_id` = '$emp_id',`code_status` = null  WHERE `M-Items`='$mitems' AND `Entry_id`='$Id'";
                ...
                if ($patientResult) {
                    ...
                    $insertQuery = "INSERT INTO `Codesegement`(`Entry_Id`, `Mrn`, `Patient_Name`, `Assessment_Date`, `M-Items`, `ICD-code`, `Description`, `Effective_Date`, `Eo`, `Rating`, `Coderchecked`,`Agencychecked`, `Agencyprimarycode`,`User`,`status`,`coder_emp_id`) 
                                VALUES ('$Id','$mrn','$patientName','$assessmentDate','$mitems','$icd','$description','$effectivedate','$eo','$rating','$coderchecked','$agencychecked','$mitemcheckingprimary','$user','$status','$emp_id')";
