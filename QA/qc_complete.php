...
if (isset($_POST['Id'])) {
    ...
    $updateQuery = "UPDATE `Main_Data` SET `status` = 'QC COMPLETED',`File_Status_Time`= '$currentDateTime',`qc_completed_date`= '$currentDateTime' WHERE `Id` = '$userId'";
    $response = [];
    ...
    if ($result && $result->num_rows > 0) {
        ...
        $emp_id = $conn->real_escape_string($row['qc_person_emp_id']);
