...
function mrn_check(fromdate,todate,mrn) {
  ...
  $.ajax({
    url: "upload/agent_files/agency_wise_report_query.php?action=mrn_search",
    type: "GET",
    dataType: "json",
    data: {
      fromdate: fromdate,
...
function patient_check(fromdate,todate,patient) {
  ...
  $.ajax({
    url: "upload/agent_files/agency_wise_report_query.php?action=patient_search",
    type: "GET",
    dataType: "json",
    data: {
      fromdate: fromdate,
...
function status_check(fromdate,todate,status) {
  ...
  $.ajax({
    url: "upload/agent_files/agency_wise_report_query.php?action=status_search",
    type: "GET",
    dataType: "json",
    data: {
      fromdate: fromdate,
...
function all_report(fromdate,todate) {
  ...
  $.ajax({
    url: "upload/agent_files/agency_wise_report_query.php?action=all_report",
    type: "GET",
    dataType: "json",
    data: {
      fromdate: fromdate,
...
$(document).on("click", ".query-icon", function () {
  ...
  $.ajax({
    url: "upload/agent_files/agency_wise_report_query.php",
    type: "GET",
    dataType: "json",
    data: {
      message: message,
