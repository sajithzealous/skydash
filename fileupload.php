        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
              <h4 class="card-title">Import File <a href="dataformat/dataformat.xlsx " download><h5 style="float:right"><img src="images/excel-icons-animation.gif" class="float-right text-overlay" title="Download formate" style="width: 12%; "> </h5></a></h4> 
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group col-xs-12">
                        ...
                        <span class="input-group-append">
                          <button class="file-upload-browse btn btn-primary float-right clk-upload"  type="button" style="background-color: #4B49AC;">Uploads</button>
                        </span>
                      </div>
                    </div>
                ...
                <script src="https://cdnjs.cloudflare.com/ajax/libs/PapaParse/5.3.0/papaparse.min.js"></script>
                  ...
                  <script src="upload/js/clinet_upload.js" type="text/javascript"></script>
...
try {
    ...
    $sth = $conn->prepare("SELECT `agency_name` FROM `Agent` WHERE `client_name` = '$user' AND `client_id`= '$emp_id'");
    $sth->execute();
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group row">
                       <label class="col-sm-3 col-form-label"><span>Agency Name </span></label>
<div class="col-sm-9">
    <select class="form-control" id="agency" name="agency" placeholder="Select Option">
       <option value="" disabled selected>Select Option</option>
        <?php
        // Assuming $coders contains the fetched agency names
        foreach ($coders as $coder) {
            echo "<option value='" . $coder['agency_name'] . "'>" . $coder['agency_name'] . "</option>";
        }
        ?>
    </select>
</div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <span id="st" style="color:red"></span>
                            <input type="text" class="form-control" id="status" name="insu_type" value="New" placeholder="New" disabled />
                         <!--  <select id="status" value="NEW" class="form-control" placeholder="NEW" value="new">
                              <option class="status" name="status" id="status" placeholder="NEW"> NEW</option>
                          </select> -->
                        </div>
                      </div>
                    </div>
