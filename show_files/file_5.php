...
if (isset($_GET['fromdate']) && isset($_GET['todate'])) {
 ...
 if($agency){
    ...
    $sql = "SELECT `Id`,`alloted_team`,`agency`,`patient_name`,`phone_number`,`mrn`,`status`,`alloted_to_coder`,`insurance_type`,'qc_person'FROM Main_Data WHERE `status`='QC COMPLETED' AND `agency` = '$agency' AND `File_Status_Time` >= '$fromdate 00:00:00' AND `File_Status_Time` <= '$todate 23:59:59'";
 }
 else{
