...
<button onclick="convert_pdf('my_document')">Convert to PDF</button>

  <div class="container-fluid " id="pdfcontainer">
                ...
                <table class="styled-table table table-hover" id="oasisqc-table"  > 
                 <thead class=""style="background: #4C4CAC;">
                  ...
                  <tbody id="oasis-nodata-table">
                    <tr>
                      <td colspan="8" class="text-center text-danger" style="border: 1px solid black; white-space: pre-wrap;">No data available</td>
                    </tr>
                  </tbody>
                </table>
              </div>
    ...
    border: 1px solid black;
              ...
              <div class="table-responsive">
                <table class="table mx-auto" id="oasisqc-cmd">
                  <thead style="color: whitesmoke; background: #4C4CAC;">
                    <tr>
                      <th scope="col">Coder Oasis Commments </th>
              ...
              <div class="table-responsive">
                <table class="table mx-auto" id="poc-cmd">
                  <thead style="color: whitesmoke; background: #4C4CAC;">
                    <tr>
                       <th scope="col">Coder Poc Commments </th>
...
var options = {
    ...
    image: { type: "jpeg", quality: 1 }, // Reduce image quality
    pagebreak: { avoid: "tr", mode: "css", before: "#nextpage1"},
    html2canvas: { scale: 4, useCORS: true, dpi:192, letterRendering: true }, // Reduce scale and DPI
  ...
  ?>
 <!-- <script src="QA/js/qc_singlepreview_2.js"></script>  -->
 <?php  $randomNumber = rand(1000, 9999);  ?>
 


    <script src="QA/js/qc_singlepreview_2.js?<?php echo $randomNumber ?>"></script>
  <script src="ggmitem/js/qc_ggitem_previwe.js"></script>
