$(document).ready(function () {
  ...
  const renderFields = (fieldData) => {
    ...
    $("#dynamic_field tbody").html(
      fieldData.map(
        (item, index) => `<tr id="row${index + 1}"  ondragstart="ondragstart(event)" ondrop="drop(event, this)" draggable="true" >
              <td style="width: 10px; padding:10px;"><span class="spanremove">${index + 1}</span></td>
          ...
          item["ICD-code"]
        }" autocomplete="off" class="form-control input_empty input-lg form-input" style="text-transform: uppercase; " data-mitem="${item["M-Items"]}"/></td>
          ...
          index + 1
        }" readonly  title="${item["Description"]}" data-mitem="${item["M-Items"]}"/></td>

      
              <td style="width: 150px;padding:10px;"><input type="text" readonly value="${
                item["Effective_Date"]
              }"name="effectivedate" autocomplete="off"  class=" form-control input_empty input-lg form-input" data-mitem="${item["M-Items"]}"/></td>
              <td style="padding:15px;width:100px">
                  <select name="eo"  class="form-control input_empty input-lg form-input " data-mitem="${item["M-Items"]}" disabled id="eo-row${
                    index + 1
                  }">
              ...
              <td style="padding:10px;">
                  <select name="rating"  class="form-control input_empty input-lg form-input" data-mitem="${item["M-Items"]}" disabled id="rating-row${
                    index + 1
                  }">
                      <option value="None">None</option>
                      <option value="0"${
              ...
              <td style="padding:10px;"><select name="qcreason" style="color: black;" class="form-control input_empty input-lg form-input qcreasonid" disabled hidden id="qcreasonid" data-mitem="${item["M-Items"]}" id="qcreason-row${
                index + 1
              }">
              <option value="None"${
              ...
              <option value="Incorrect FOC"${
                ...
                <option value="Missed to Follow ICD Guideline"${
                 ...
                 <option value="Missed to Follow HH Guideline"${
                  ...
                  <option value="Misssing Comorbid conditions"${
                        item. Error_reason === "Misssing Comorbid conditions" ? "selected" : ""
               ...
               <td style="padding:10px;"><select name="errortype" style="color: black;" class="form-control input_empty input-lg form-input errortypeid" disabled hidden id="errortypeid" data-mitem="${item["M-Items"]}" id="errortype-row${
                 index + 1
               }">
               <option value="None"${
    ...
    width: 337px;" class="form-control-sm input_empty input-lg form-input Qarationaileid" disabled hidden   data-mitem="${item["M-Items"]}" id="Qarationaile-row${index + 1}"></textarea>
 
</td>


         <td style="padding:10px"> <button type="button" class="btn mt-2 addnewcode" data-mitem="${item["M-Items"]}"><i class="fas fa-edit" title="Add"style="color:#31029c; cursor: pointer;"></i></button></td>
...
$(document).ready(function() {
  ...
  const generateRandomString = () => {
    ...
    const formattedRandomString = `M10${valuelastdata}${String.fromCharCode(currentCharCode)}`;
  ...
  $("body").on("click","#add",function () {
    ...
    var rowC = $(".codesegement #dynamic_field tbody tr:last-child td:first-child span").text();
      ...
      success: function (response) {
        ...
        if (response == "") {
          Swal.fire({
            ...
            qcscoringdisplay();
            $('#oasisscoringcontainer').load(window.location.href +"#oasisscoringcontainer");
          });
        }
...
// function qcReasondata() {
//   $.ajax({
//     url: "QA/qc_reason.php",
//     type: "GET",
//     dataType: "json",
//     success: function (data) {
//       // console.log(data);
//       if (data) {
//         var select = $(".qcreasonid"); // Selecting the element by its class
...
//       // console.log(data);
//       if (data) {
//         var select = $(".errortypeid"); // Selecting the element by its class
//         select.empty(); // Clearing any existing options
...
//       // console.log(data);
//       if (data) {
//         var select = $(".qcreasonida_add"); // Selecting the element by its class
//         select.empty(); // Clearing any existing options
...
//       // console.log(data);
//       if (data) {
//         var select = $(".errortypeid_add"); // Selecting the element by its class
//         select.empty(); // Clearing any existing options
...
//qcscoring automatically fetch from database
...
function qcscoringdisplay() {
  ...
  $.ajax({
    type: "post",
    url: "QA/qcscoringfetch.php?action=codescore",
    data: {
      Id: Id,
    },
