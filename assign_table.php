    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-md-2">
                    ...
                    <?php
                    include 'filter/Status_filter_v2.php';
                    ?>
                  </div>
                  <div class="col-md-3">
                  ...
                  <div class="col-md-3 mr-5">
                    ...
                    <button type="button" class="btn btn-primary ml-5" id="search">
                      Search</button>
                    <button type="button" class="btn btn-primary ml-5" id="Coder_Assign">
                      Assign</button>
                  </div>
          ...
          <div class="card mb-3" id="tablerefresh">
            <div class="row">
...
<style>
                    ...
                    <div class="row">
                      <div class="col-12">
                        <div class="table-responsive">
                          <table id="assign_table_data" class="display expandable-table" style="width:100%">
                            <thead>
                              <tr class="table">
                              </tr>
                            </thead>
                            <tbody class="table" id="assign_table_data">
                            </tbody>
                          </table>
                ...
                <div class="col-md-12 grid-margin stretch-card">
                  <div class="card">
                    <div class="card-body">
                      <div class="row">
                        <div class="col-auto">
                          <p class="card-title">Pending Files</p>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-12">
                          <div class="table-responsive">
                            <table id="pending_table_data" class="display expandable-table" style="width:100%">
                              <thead>
                                <tr class="table">
                                </tr>
                              </thead>
    ...
    ?>
     <?php $randnum =rand(0000,9999)?>
    <!-- <script src="table/js/table.js"></script> -->
    <script src="Assign/js/pending_table.js?<?php echo $randnum ?>"></script>
