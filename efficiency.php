...
include 'style.php';
 ?>
    ...
    <div class="card">
        <div class="card-body">
            <p class="card-title mb-0 text-primary text-uppercase">Efficiency-Report</p><br><br>
...
<div class="col-md-2">
    ...
    <div class="form-group row">
        <div class="col-sm-10">
        <select class="form-control" name="Agency" id="agency5" style="color:black;">
 ...
 <div class="row">
            ...
            <table class="table table table-striped   table-hover" width="110%">
              <thead class="bg-primary text-white" id="headers1" >
                <tr>
                  ...
                  <th id="head" class="pl-0 pb-2 border-bottom" style="text-align: center;">AgencyName</th>
                  <th id="head" class="pb-2 border-bottom" style="text-align: center;">TeamName</th>
                  <th id="head" class="pl-0 pb-2 border-bottom" style="text-align: center;">CoderName</th>
                   <th id="head" class="pl-0 pb-2 border-bottom" style="text-align: center;">Coder_EmpId</th>
                  ...
                  <th id="head" class="border-bottom pb-2" style="text-align: center;">Total Workinghours</th>
                </tr>
              </thead>
    ...
    <script>
        document.getElementById('download_excel').addEventListener('click', function () {
            ...
            XLSX.writeFile(wb, "Efficiency-Report.xlsx");
        });
