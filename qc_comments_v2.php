...
<style>
    ...
    /* CSS to enable textarea resizing */
.resizable-textarea {
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content p-2">
                                ...
                                <div class="form-group" style="float:right">
                                    ...
                                    <button class="cmd_button mr-5 saveclass" id="qc_cmd">
                                ...
                                <div class="form-group m-3">
                                    ...
                                    <textarea
                                        ...
                                        id="qc_codesegment_cmd" rows="10"
                                        placeholder="Enter your comment here..."><?php echo $coding_comments?></textarea>
                                </div>
                                <br>
                                <div class="form-group m-3">
                                    ...
                                    <textarea
                                        class="form-control resizable-textarea shadow bg-white rounded scrollable-textarea myTextarea"
                                        id="qc_oasissegment_cmd" rows="10"
                                        placeholder="Enter your comment here..."><?php echo $oasis_comments?></textarea>
                                </div>
                                <br>
                                ...
                                <div class="form-group m-3">
                                    ...
                                    <textarea
                                        class="form-control resizable-textarea shadow bg-white rounded scrollable-textarea myTextarea"
                                        id="qc_poc_cmd" rows="10" placeholder="Enter your comment here..."><?php echo $poc_comments?></textarea>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
