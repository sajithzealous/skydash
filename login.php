...
<!-- <form id="changepasswordform" hidden>
  <div class="form-group row mt-5">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="useridc" placeholder="Enter Your User Id" required>
    </div>
  </div>
  <div class="form-group row">
    <label for="inputPassword3" class="col-sm-4">Password</label>
    <div class="col-sm-8">
      <input type="password" class="form-control" id="inputPassword" placeholder="Enter Your New Password" required>
    </div>
  </div>
      <div class="form-group row">
    <label for="cpassword" class="col-sm-4">Confirm Password</label>
    <div class="col-sm-8">
      <input type="password" class="form-control" id="cpassword" placeholder="Enter The Same Password" required>
    </div>
  </div>
</form>
 -->
